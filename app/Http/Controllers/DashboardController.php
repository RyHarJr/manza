...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $transaksiPerBulan = DB::select("SELECT DATE_FORMAT(TglTransaksi, '%Y-%m') as bulan, COUNT(*) as total, SUM(TotalHarga) as revenue FROM transaksis GROUP BY DATE_FORMAT(TglTransaksi, '%Y-%m') ORDER BY bulan");
        ...
        return view('dashboard', compact(
            'totalModal', 'totalKeuntungan',
            'produkPerKategori', 'transaksiPerBulan', 'statusPembayaran', 'stokPerProduk',
            'topPelanggan', 'topKasir', 'topProduk'
        ));
    }
}
