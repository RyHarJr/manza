...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="card border-0 p-4">
            <h5 class="fw-bold text-primary mb-4">Edit Data Produk</h5>
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="KategoriProduk" name="KategoriProduk" required>
                ...
                <option value="Makanan" {{ old('KategoriProduk', $produk->KategoriProduk) == 'Makanan' ? 'selected' : '' }}>Makanan</option>
                <option value="Minuman" {{ old('KategoriProduk', $produk->KategoriProduk) == 'Minuman' ? 'selected' : '' }}>Minuman</option>
                <option value="Snack" {{ old('KategoriProduk', $produk->KategoriProduk) == 'Snack' ? 'selected' : '' }}>Snack</option>
                <option value="Bumbu" {{ old('KategoriProduk', $produk->KategoriProduk) == 'Bumbu' ? 'selected' : '' }}>Bumbu</option>
                <option value="Sembako" {{ old('KategoriProduk', $produk->KategoriProduk) == 'Sembako' ? 'selected' : '' }}>Sembako</option>
                <option value="Peralatan" {{ old('KategoriProduk', $produk->KategoriProduk) == 'Peralatan' ? 'selected' : '' }}>Peralatan</option>
                <option value="Lainnya" {{ old('KategoriProduk', $produk->KategoriProduk) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
            </select>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="NamaProduk" name="NamaProduk"
                value="{{ old('NamaProduk', $produk->NamaProduk) }}" required>
            @error('NamaProduk')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="Deskripsi" name="Deskripsi"
                value="{{ old('Deskripsi', $produk->Deskripsi) }}" required>
            @error('Deskripsi')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <small class="text-muted">Kosongkan jika tidak ingin mengubah foto. Format: JPEG, PNG, JPG, GIF. Maks 2MB.</small>
            @error('Foto')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
