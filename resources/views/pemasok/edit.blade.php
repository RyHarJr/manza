...
@section('title')
    <h1><i class="bi bi-pencil-square me-2"></i>Edit Pemasok</h1>
@endsection
...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="card border-0 p-4">
            <h5 class="fw-bold text-primary mb-4">Edit Data Pemasok</h5>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="NamaPemasok" name="NamaPemasok"
                value="{{ old('NamaPemasok', $pemasok->NamaPemasok) }}" required>
            @error('NamaPemasok')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="NoTlp" name="NoTlp"
                value="{{ old('NoTlp', $pemasok->NoTlp) }}" maxlength="14" required>
            @error('NoTlp')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="KontakPerson" name="KontakPerson"
                value="{{ old('KontakPerson', $pemasok->KontakPerson) }}" required>
            @error('KontakPerson')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
                ...
                <div class="d-flex gap-2 mt-4">
                    <a href="{{ route('pemasok.index') }}" class="btn btn-light px-4"><i class="bi bi-arrow-left me-1"></i> Batal</a>
