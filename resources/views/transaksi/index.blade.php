...
<div class="card border-0 p-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="mb-0 fw-bold text-slate">Riwayat Transaksi</h5>
        <a href="{{ route('transaksi.create') }}" class="btn btn-dark"><i class="bi bi-plus-circle me-1"></i> Tambah Manual</a>
    </div>
